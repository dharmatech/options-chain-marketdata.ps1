...
function chart-volume ($symbol, $expirations, $dte, $as_of)
{
    if ($dte -ne $null)
    {
    ...
    $datasets_calls = foreach ($chain in $chains)
    {
        $data = $strikes_union | % {
            ...
            if ($call -eq $null) { 0 } else { $call.volume }
        }
    ...
    # ----------------------------------------------------------------------
    $total_calls_vol = $chains | % { $chain = $_; $chain.calls | Measure-Object volume -Sum | % Sum } | Measure-Object -Sum | % Sum
    $total_puts_vol  = $chains | % { $chain = $_; $chain.puts  | Measure-Object volume -Sum | % Sum } | Measure-Object -Sum | % Sum    
    # ----------------------------------------------------------------------
        ...
        chart = @{
            ...
            options = @{
                title = @{ 
                    display = $true
                    text = @(
                        ('{0} Volume as of {1}' -f $symbol, $(if ($as_of) { $as_of } else { (Get-Date -Format 'yyyy-MM-dd HH:mm') })),
                        ("total calls volume: {0}" -f $total_calls_vol.ToString('N0')),
                        ("total puts volume: {0}" -f $total_puts_vol.ToString('N0')),
...
chart-volume $symbol $expirations $dte $as_of

# ----------------------------------------------------------------------           
exit
# ----------------------------------------------------------------------           

# $chains_spy  = .\chart-volume-marketdata.ps1 SPY  '2023-06-30', '2023-07-07', '2023-07-14', '2023-07-21', '2023-07-28', '2023-08-04', '2023-08-18', '2023-09-15'
$chains_spy = .\chart-volume-marketdata.ps1 SPY
# $chains_spy = .\chart-volume-marketdata.ps1 SPY -dte 90

$chains_nvda = .\chart-volume-marketdata.ps1 NVDA '2023-07-07', '2023-07-14', '2023-07-21', '2023-07-28', '2023-08-04', '2023-08-18', '2023-09-15'

$chains_qqq  = .\chart-volume-marketdata.ps1 QQQ  '2023-06-30', '2023-07-07', '2023-07-14', '2023-07-21', '2023-07-28', '2023-08-04', '2023-08-18', '2023-09-15'
$chains_qqq  = .\chart-volume-marketdata.ps1 QQQ -dte 90

$chains_tsla = .\chart-volume-marketdata.ps1 TSLA '2023-06-30', '2023-07-07', '2023-07-14', '2023-07-21', '2023-07-28', '2023-08-04', '2023-08-18', '2023-09-15'
$chains_tlt  = .\chart-volume-marketdata.ps1 TLT  '2023-06-30', '2023-07-07', '2023-07-14', '2023-07-21', '2023-07-28', '2023-08-04', '2023-08-18', '2023-09-15'
$chains_gld  = .\chart-volume-marketdata.ps1 GLD  '2023-06-30', '2023-07-07', '2023-07-14', '2023-07-21', '2023-07-28', '2023-08-04', '2023-08-18', '2023-09-15'
$chains_uso  = .\chart-volume-marketdata.ps1 USO  '2023-06-30', '2023-07-07', '2023-07-14', '2023-07-21', '2023-07-28', '2023-08-04', '2023-08-18', '2023-09-15'
# $chains_ung  = .\chart-volume-marketdata.ps1 UNG  '2023-06-30', '2023-07-07', '2023-07-14', '2023-07-21', '2023-07-28', '2023-08-04', '2023-08-18'
$chains_ung = .\chart-volume-marketdata.ps1 UNG
# $chains_kre  = .\chart-volume-marketdata.ps1 KRE  '2023-06-30', '2023-07-07', '2023-07-14', '2023-07-21', '2023-07-28', '2023-08-04', '2023-08-18', '2023-09-15'
$chains_kre  = .\chart-volume-marketdata.ps1 KRE
$chains_coin = .\chart-volume-marketdata.ps1 COIN 


$chains_nke = .\chart-volume-marketdata.ps1 NKE
$chains_tgt = .\chart-volume-marketdata.ps1 TGT

$chains_envx = .\chart-volume-marketdata.ps1 ENVX
$chains_trup = .\chart-volume-marketdata.ps1 TRUP

$chains_trup = .\chart-volume-marketdata.ps1 CVNA
...
$chains_spy = .\chart-volume-marketdata.ps1 -symbol SPY -as_of '2022-01-04' # high
$chains_spy = chart-volume -symbol SPY -as_of '2022-03-08' # low
$chains_spy = chart-volume -symbol SPY -as_of '2022-03-29' # high
$chains_spy = chart-volume -symbol SPY -as_of '2022-06-17' # low
$chains_spy = chart-volume -symbol SPY -as_of '2022-08-12' # high
$chains_spy = chart-volume -symbol SPY -as_of '2022-10-13' # low
$chains_spy = chart-volume -symbol SPY -as_of '2022-12-01' # high
$chains_spy = chart-volume -symbol SPY -as_of '2022-12-28' # low
$chains_spy = chart-volume -symbol SPY -as_of '2023-02-02' # high
$chains_spy = chart-volume -symbol SPY -as_of '2023-03-13' # low
$chains_spy = .\chart-volume-marketdata.ps1 -symbol SPY


$chains_spy = chart-volume -symbol SPY -expirations $result_expirations -as_of '2022-08-12' # high
